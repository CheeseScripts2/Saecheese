-- LEVON HUB presence heartbeat
local __blyxo_req = request or http_request or (syn and syn.request)
local __blyxo_id = tostring(game.JobId or math.random(100000, 999999))
local function __blyxo_presence()
  local __blyxo_body = '{"mode":"presence","loader":"blyxohub-test-fc5d93fd","clientId":"' .. __blyxo_id .. '"}'
  if __blyxo_req then
    pcall(function() __blyxo_req({Url="https://blyxo-hub-website.vercel.app/api/analytics/record", Method="POST", Headers={['Content-Type']='application/json'}, Body=__blyxo_body}) end)
  else
    pcall(function() game:GetService("HttpService"):RequestAsync({Url="https://blyxo-hub-website.vercel.app/api/analytics/record", Method="POST", Headers={['Content-Type']='application/json'}, Body=__blyxo_body}) end)
  end
end
local function __blyxo_leave()
  local __blyxo_body = '{"mode":"leave","loader":"blyxohub-test-fc5d93fd","clientId":"' .. __blyxo_id .. '"}'
  if __blyxo_req then
    pcall(function() __blyxo_req({Url="https://blyxo-hub-website.vercel.app/api/analytics/record", Method="POST", Headers={['Content-Type']='application/json'}, Body=__blyxo_body}) end)
  else
    pcall(function() game:GetService("HttpService"):RequestAsync({Url="https://blyxo-hub-website.vercel.app/api/analytics/record", Method="POST", Headers={['Content-Type']='application/json'}, Body=__blyxo_body}) end)
...
if task and task.spawn then task.spawn(function()
  __blyxo_presence()
  while task.wait(10) do __blyxo_presence() end
end) end
pcall(function() game:GetService("Players").LocalPlayer.AncestryChanged:Connect(function(_, parent) if not parent then __blyxo_leave() end end) end)

-- LEVON HUB | Steal An Egg
...
BX.module("ui.splash", function(BX)
    ...
    -- CHEESE HUB yellow palette
    local PURPLE_DARK  = Color3.fromRGB(30, 25, 0)
    local PURPLE_MID   = Color3.fromRGB(50, 45, 0)
    local PURPLE_LITE  = Color3.fromRGB(80, 70, 0)
    local PURPLE_GLOW  = Color3.fromRGB(255, 200, 0)
    local PURPLE_FILL1 = Color3.fromRGB(255, 220, 0)
    local PURPLE_FILL2 = Color3.fromRGB(220, 160, 0)
    ...
    local ok, err = pcall(function()
        ...
        -- ══════════════════════════════════════════════════════════════════
        -- INTRO SCREEN FULLSCREEN — LEVON HUB ON TOP — viola lampeggiante
        ...
        pcall(function()
            ...
            -- Sfondo transparente fullscreen
            ...
            shadow.TextSize = 78
            shadow.TextColor3 = Color3.fromRGB(100, 80, 0)
            ...
            -- Testo glow lampeggiante (strato giallo)
            ...
            glowTxt.TextSize = 82
            glowTxt.TextColor3 = Color3.fromRGB(255, 220, 0)
            ...
            mainTxt.Text = '<font color="#FFFF00">CHEESE</font> <font color="#FFD700">HUB</font>'
            mainTxt.ZIndex = 5
            mainTxt.Parent = bg
            ...
            badge.BackgroundColor3 = Color3.fromRGB(180, 140, 0)
            badge.BackgroundTransparency = 0.1
            badge.BorderSizePixel = 0
            badge.Font = Enum.Font.GothamBlack
            badge.TextSize = 14
            badge.TextColor3 = Color3.fromRGB(255, 255, 200)
            ...
            neon.BackgroundColor3 = Color3.fromRGB(255, 200, 0)
        ...
        -- LEVON HUB ON TOP: intro premium compatta, titolo su una sola riga.
        ...
        local titleShadow = mk("TextLabel", {
            ...
            Text = '<stroke color="#16002D" joins="round" thickness="5">LEVON</stroke> <font color="#5710A0"><stroke color="#20003C" joins="round" thickness="3">HUB</stroke></font>',
        }, card)
        ...
        local title = mk("TextLabel", {
            ...
            Text = '<font color="#FFFFFF"><stroke color="#B52CFF" joins="round" thickness="2">LEVON</stroke></font> <font color="#D45CFF"><stroke color="#8D18FF" joins="round" thickness="2.5">HUB</stroke></font>',
        }, card)
        ...
        local glowTitle = mk("TextLabel", {
            ...
            Text = '<font color="#D54CFF">LEVON</font> <font color="#E18CFF">HUB</font>',
        }, card)
           ...
           and type(writefile) == "function" then
            ...
            sc:spawn("icons", function()
                BX.try("stats.iconDirs", function()
                    for _, dir in ipairs({ "LEVON HUB", ICON_ROOT, ICON_DIR }) do
...
BX.module("ui.window", function(BX)
    ...
    -- LEVON HUB: cerchio flottante ULTRA FIGO v2
    ...
    function M.build(tab)
        ...
        tab:CreateButton({
            ...
            callback = function()
                ...
                win.notify("LEVON HUB", copied and "Invite copied to clipboard" or "Join at discord.gg/PeCKde5Uv")
            end,
        })
...
do
    ...
    logmod.session(("LEVON HUB %s build %s | generation %d")
    ...
    if not stage("services", true, function()
        ...
        warn("[LEVON] startup failed at services: " .. tostring(startup.error))
        warn("[LEVON] see LevonHub_trace.txt")
        return
    end
    ...
    -- =========================================================================
    -- LEVON HUB OVERLAY GUI
    -- A compact draggable overlay that mirrors the LEVON HUB aesthetic.
    ...
    BX.try("fox.overlay", function()
        ...
        local LEVON_LOGO  = "rbxassetid://114534441742480"
        local LEVON_BANNER = "rbxassetid://116092620575995"
        ...
        -- ── LEVON HUB centrato nella titleBar (senza logo) ───────────────
        ...
        -- Underline elettrico sotto LEVON HUB
    ...
    --
    --     getgenv().BlyxoStartup     what happened during startup, stage by stage
    --     getgenv().BlyxoAudit()     what the hub is holding, right now
    --     getgenv().BlyxoProfile()   per-frame cost by feature, worst first
    env.BlyxoAudit = function()
        local h = BX.profile.health()
        print(("[LEVON] up %.0fs | mem %.0fMB (%+.0f since start) | %d modules")
            :format(h.uptime, h.mem, h.memGrow, h.loaded))
        print(("[LEVON] scopes=%d conns=%d insts=%d threads=%d")
            :format(h.scopes, h.conns, h.insts, h.threads))
        for _, line in ipairs(BX.scopeReport()) do print("[LEVON]   " .. line) end
        for _, line in ipairs(BX.profile.watched()) do print("[LEVON]   " .. line) end
        local rep = logmod.repeats()
        if #rep > 0 then
            print("[LEVON] repeated failures:")
            for _, r in ipairs(rep) do print("[LEVON]   " .. r) end
        end
        return h
    end

    env.BlyxoProfile = function()
        for _, line in ipairs(BX.profile.report()) do print("[LEVON] " .. line) end
    end
    ...
    --
    --     getgenv().BlyxoDiag()   prints it again at any time
    local function diag()
        local rep = BX.require("core.exec").report()
        local lines = {
            ("executor = %s  (LEVON HUB %s build %s, generation %d)")
